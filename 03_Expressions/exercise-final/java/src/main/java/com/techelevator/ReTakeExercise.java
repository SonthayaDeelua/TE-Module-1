...
public class ReTakeExercise {
	 ...
	 * Additionally, it's just fun to know. // Note, this alternative only works
	 * with ints and longs. // a = a + b; // b = a - b; // a = a - b; }
	 * 
	 ...
	 * higher in all cases. caughtSpeeding(60, false) → 0 caughtSpeeding(65,
	 * false) → 1 caughtSpeeding(65, true) → 0
	 */
