...
public class Dog {
	...
	//another constructor that take in a string
	//we say this constructor is OVERLOAD because there
	//are tow difference methods of the same name
	public Dog(String name ) { //constructor will pull string
		this.name = name;
	}
	// another constructor that take all 3 data members
	//OVERLOAD AGAIN! Because it is named the same
