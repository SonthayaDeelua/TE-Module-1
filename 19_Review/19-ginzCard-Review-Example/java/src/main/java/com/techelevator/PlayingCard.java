...
public class PlayingCard {
	 ...
	 * Member data
	 * 
	 * protected so subclasses may access 
	 ***************************************************************************************************/
	...
	public PlayingCard() 
	{
		...
		suit  = DEFAULTSUIT;
		setColor(suit);     // Set color in object based on suit - NOTE: suit must have a value befor this
	} 
	/***************************************************************************************************
	...
	public int getIntValue() {    // Return integer value of CardValue stored in the object
		return value.ordinal(); //ordinal is a method specific to enums
	}
...
@Override   // Ask compiler to assure this is a valid super class override
	...
	public int hashCode() {   // Generate hashCode for object if Java needs one - HashCode is a unique value representing an instance of an object
		int hashValue = 17;
